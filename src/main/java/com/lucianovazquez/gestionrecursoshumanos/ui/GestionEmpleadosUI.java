...
public class GestionEmpleadosUI extends javax.swing.JPanel {
    ...
    ModificarEmpleadoUI panelModificar;
    ...
    private void jButtonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModificarActionPerformed
        ...
        int id_ingresado = Integer.valueOf(jTextField1.getText());
        String dni = String.valueOf(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 4));

        if (tipo.equals("N° de Legajo")) {
            empleado = empBO.buscarEmpleadoId(id_ingresado);
            panelModificar = new ModificarEmpleadoUI(panelContenedor, usuario, panelSesion, empleado);
            panelContenedor.add(panelModificar);
            panelModificar.setVisible(true);
            this.setVisible(false);
        }
        if (tipo.equals("DNI")) {
            empleado = empBO.buscarEmpleadoDni(dni);
            panelModificar = new ModificarEmpleadoUI(panelContenedor, usuario, panelSesion, empleado);
            panelContenedor.add(panelModificar);
            panelModificar.setVisible(true);
            this.setVisible(false);
